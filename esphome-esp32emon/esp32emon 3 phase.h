...
// Polling interval
#define POLLING_INTERVAL 20000 //Every 30s will perform a read and publish the data. Do not go under 5s to prevent crashes.

// Pin configuration
#define V1 35
#define V2 32 //Set to V1 if using only one voltage meter
#define V3 33 //Set to V1 if using only one voltage meter
